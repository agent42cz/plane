...
ATTACHMENT_MIME_TYPES = [
    ...
    # Macro-enabled and template Office formats. Browsers and signature sniffers report
    # these for perfectly ordinary spreadsheets/documents, so leaving them out rejects
    # real business files (note: sniffers emit "macroenabled" lower-cased, which is why
    # membership is tested case-insensitively -- see is_allowed_attachment_mime).
